# Documento maestro — sitio web PSICONEXSOC

Este archivo es el índice del desarrollo. Cada etapa tiene un documento propio. Lo ya decidido no se reescribe: se apunta.
...
| 5. Spec visual | [07-spec-visual.md](07-spec-visual.md), [08-tajo-honrar-la-tesis.md](08-tajo-honrar-la-tesis.md) | Ley en 07; el tajo se cerró hacia la tesis (08). Home aún no redibujada |
| 6. Dominio | [05-dominio-psiconexsoc-com.md](05-dominio-psiconexsoc-com.md) | Preparado; no cortar hasta registrar |

**Nombre.** PSICONEXSOC

**Descriptor.** Clínica, investigación y divulgación psicoanalítica

**Consigna.** La palabra tiene efectos.

**No es.** Una vitrina de consultorio, un blog informal, ni la página de una escuela cerrada.
